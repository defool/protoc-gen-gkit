...
func RegisterExampleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExampleServiceServer) error {
	...
	mux.Handle("POST", pattern_ExampleService_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/foo.v1.ExampleService/SayHello", runtime.WithHTTPPathPattern("/foo.v1.ExampleService/SayHello"))
		if err != nil {
...
func RegisterExampleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ExampleServiceClient) error {
	...
	mux.Handle("POST", pattern_ExampleService_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/foo.v1.ExampleService/SayHello", runtime.WithHTTPPathPattern("/foo.v1.ExampleService/SayHello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ExampleService_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"foo.v1.ExampleService", "SayHello"}, ""))
)
